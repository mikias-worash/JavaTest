/*
    Library of functions for Dictionary App
        ...
        if(!reader.fail()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                while(j < count) {
                    ...
                    reader.read((char *) &dic, sizeof(dic));
                    if (i == 0 && strcmp(dic.type,"n") == 0 || i == 1 && strcmp(dic.type,"v") == 0 
                       || i == 2 && strcmp(dic.type,"adj") == 0 || i == 3 && strcmp(dic.type,"adv") == 0) {
                        cout<<endl;
                        cout<<"Word: "<<dic.word<<endl;
                        cout<<"Type: "<<dic.type<<endl;
                        cout<<"Pron: "<<dic.pron<<endl;
                        cout<<"Meaning: "<<dic.meaning<<endl<<endl;
                    }
                    cur = cur->next;
                    j++;
                }
